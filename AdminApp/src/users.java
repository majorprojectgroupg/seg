...
public class users {
	...
	private static String executestaement = "SELECT * FROM users"; // used by other methods
	...
	public static Boolean individual_log= false, logout=false;

	private static 	MessageBox alert_message , confirm;
	/**
	...
	protected users(final Display display) {
		...
		composite.setBounds(10, 22, 578, 194);
		...
		user_table.setBounds(0, 24, 578, 170);
		...
		alert_message = new MessageBox(shell ,SWT.ICON_WARNING|SWT.OK);
		confirm = new MessageBox(shell,SWT.ICON_INFORMATION|SWT.OK);
		...
		btnAdd.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if(txt_fname.getText().length()==0 ||txt_lname.getText().length()==0||txt_username.getText().length()==0|| txt_password.getText().length()==0 ||txt_role.getText().length()==0||cmbo_ulevel.getSelectionIndex()==0){
					...
					alert_message.setMessage("Please Fill in all the fields under UserInfo");
					alert_message.setText("Alert!");
					alert_message.open();
				}else{

					alert_message = new MessageBox(shell ,SWT.ICON_QUESTION|SWT.OK|SWT.NO);
					alert_message.setMessage("Are you sure you would like to add "+txt_fname.getText()+" "+txt_lname.getText()+"to the user database");
					...
					if(confirmation==SWT.OK){
						...
						confirm.setMessage("You have successfully added a new user to the system");
						...
						System.out.println("user does not want to add the new user");
					}
				}
		...
		btnUpdate.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				if(txt_fname.getText().length()==0 ||txt_lname.getText().length()==0||txt_username.getText().length()==0|| txt_password.getText().length()==0 ||txt_role.getText().length()==0||cmbo_ulevel.getSelectionIndex()==0){
					...
					alert_message = new MessageBox(shell ,SWT.ICON_QUESTION|SWT.OK|SWT.NO);
					alert_message.setMessage("Are you sure you would like to update the user record "+txt_fname.getText()+" "+txt_lname.getText());
					alert_message.setText("Confirmation");
					...
					if(confirmation==SWT.OK){
						...
						System.out.println("user did not want to update the record");
					}
		...
		btnDelete.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				alert_message = new MessageBox(shell,SWT.ICON_QUESTION);
				alert_message.setText("Confirmation");
				alert_message.setMessage("Are you sure you would like to delete the user "+txt_fname.getText()+" "+txt_lname.getText());
				...
				if(confirmation==SWT.OK){
					...
					queries.delete_add_update(updatelog);
					confirm.setMessage("You have successfully deleted the user from the database");
					confirm.setText("Success");
					confirm.open();
					...
					System.out.println("user did not want to delete the selected username");
				}
			}
		});
		...
		btnDisable.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				alert_message = new MessageBox(shell,SWT.ICON_QUESTION);
				alert_message.setText("Confirmation");
				alert_message.setMessage("Are you sure you would like to disable the user "+txt_fname.getText()+" "+txt_lname.getText());
				...
				if(confirmation==SWT.OK){
					...
					confirm.setMessage("You have successfully disabled the user");
					confirm.setText("Success");
					confirm.open();
					...
					System.out.println("user did not want to disable the selected username");// debugging
				}
			}
		});
		...
		btnEnable.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				...
				alert_message = new MessageBox(shell,SWT.ICON_QUESTION);
				alert_message.setText("Confirmation");
				alert_message.setMessage("Are you sure you would like to enable the user "+txt_fname.getText()+" "+txt_lname.getText());
			int  confirmation = alert_message.open();
				...
				if(confirmation==SWT.OK){
					...
					confirm.setMessage("You have successfully enabled the user");
					confirm.setText("Success");
					confirm.open();
					...
					System.out.println("user did not want to enable the user logon"); // debuggin
				}
			}
		});
		...
		menu_additional.setText("Additional Tools");
		...
		menu_item_individual_log.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				if(txt_UserId.getText().length()==0){
					...
					alert_message.setMessage("Please select a user to view their individual log");
					alert_message.setText("Alert!");
					alert_message.open();
				}
				else{
		...
		TableColumn colm_userid = new TableColumn(user_table, SWT.NONE);
		colm_userid.setText("User ID");

		TableColumn colm_fname = new TableColumn(user_table, SWT.NONE);
		colm_fname.setText("First Name");

		TableColumn colm_lname = new TableColumn(user_table, SWT.NONE);
		colm_lname.setText("Last Name");

		TableColumn colm_role = new TableColumn(user_table, SWT.NONE);
		colm_role.setText("Role");

		TableColumn colm_username = new TableColumn(user_table, SWT.NONE);
		colm_username.setText("User Name");

		TableColumn colm_password = new TableColumn(user_table, SWT.NONE);
		colm_password.setText("Password");

		TableColumn colm_userlevel = new TableColumn(user_table, SWT.NONE);
		colm_userlevel.setText("User Level");
		...
		for (int i=0; i<user_table.getColumnCount(); i++) { // resizing column sizes
			user_table.getColumn (i).pack ();
		}    
